...
public class ConstantesSQL {
    //Constantes para poder utilizar consultas de tipo DDL
    //Base de datos
    ...
    public static final String CREAR_TBL_BEBIDA = "CREATE TABLE "+TBL_BEBIDA+
            " ("+CAMPO_CODIGO+" INTEGER PRIMARY KEY AUTOINCREMENT,"+ CAMPO_NOMBRE+" TEXT NOT NULL,"+ CAMPO_SABOR+" TEXT NOT NULL,"+
                CAMPO_PRESENTACION+" INTEGER NOT NULL,"+ CAMPO_TIPO+" TEXT NOT NULL,"+ CAMPO_PRECIO+" DOUBLE NOT NULL)";
    //Borrar tabla
